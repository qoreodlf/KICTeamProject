...
<body>
    ...
    <header>
        ...
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/member/loginform">SIGN IN</a></li>
            <li><a href="${pageContext.request.contextPath}/member/loginform">SIGN UP</a></li>
        </ul>
    </header>

    <!-- Main Body -->
    <section id="mainsec">
        <img src="${pageContext.request.contextPath}/SITE/IMG/index/stars.png" id="stars">
        <img src="${pageContext.request.contextPath}/SITE/IMG/index/moon.png" id="moon">
        <img src="${pageContext.request.contextPath}/SITE/IMG/index/mountains_behind.png" id="mountains_behind">
        <h2 id="title_text">자격증 공부하자.</h2>
        <a href="#sec" id="btn">자격증 보러가기</a>
        <img src="${pageContext.request.contextPath}/SITE/IMG/index/mountains_front.png" id="mountains_front">
    </section>
    ...
    <!-- EXPAND UP -->
    <a href="#mainsec">
        <span class="material-symbols-outlined" id="expand_up">
            expand_less
        </span>
    </a>
                ...
                <div class="cards__wrapper" onclick="location.href='#'">
                    <div class="card current--card">
                        <div class="card__image">
                            <!-- 기능사 -->
                            <img src="${pageContext.request.contextPath}/SITE/IMG/index/technician3.png" alt="" />
                    ...
                    <div class="card next--card">
                        <div class="card__image">
                            <!-- 기사 -->
                            <img src="${pageContext.request.contextPath}/SITE/IMG/index/technician1.png" alt="" />
                        </div>
                    </div>
            ...
            <div class="infoList">
                <div class="info__wrapper">
                    ...
                    <div class="info next--info">
                        ...
                        <h4 class="text location"></h4>
                        <p class="text description"><a href="${pageContext.request.contextPath}/losh/exlist">자세히
                                보기</a></p>
                    </div>
